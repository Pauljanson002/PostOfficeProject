    ...
    <div class="container">
        <form action="<c:url value='/settings'/>" method="post">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="inputUserID" disabled value="<c:out value='${customer.id}'/>" >
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputFirstName" name="firstName" value="<c:out value='${customer.firstName}'/>" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputLastName" class="col-sm-2 col-form-label">Last Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputLastName" name="lastName" value="<c:out value='${customer.lastName}'/>" required>
                </div>
            </div>
